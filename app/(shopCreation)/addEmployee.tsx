...
const AddEmployeesScreen = () => {
  ...
  const addEmployee = () => {
    ...
    const employee = mockDatabase.find((emp) => emp.email === email) || { name: email, email };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.employeeList}>
        ...
        {shopDetails.employees.length === 0 && <Text style={{ color: "#A0A0A0", marginTop: 20 }}>No employees added yet</Text>}
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.skipButton} onPress={() => router.push("/grantRestock")}> 
          <Text style={styles.skipText}>Skip</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.continueButton, shopDetails.employees.length === 0 && styles.disabledButton]}
...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: "row", alignItems: "center", backgroundColor: "#EEF5F1", borderRadius: 10, paddingHorizontal: 10, marginTop: 10 },
  input: { flex: 1, fontSize: 16, color: "#000", padding: 10 },
  subTitle: { fontSize: 18, color: "black", marginTop: 10 },
  employeeList: { flex: 1, backgroundColor: "#fff", borderRadius: 10, padding: 30, marginTop: 20, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 5, elevation: 5 },
  employeeCard: { flexDirection: "row", alignItems: "center", paddingVertical: 5 },
  employeeName: { flex: 1, marginLeft: 10, fontSize: 16, color: "#000" },
  buttonContainer: { flexDirection: "row", justifyContent: "space-between", marginTop: 80 },
  skipButton: { flex: 1, borderWidth: 1, borderColor: "black", borderRadius: 25, paddingVertical: 12, alignItems: "center" },
  skipText: { fontSize: 16, color: "black" },
  continueButton: { flex: 1, backgroundColor: "#6AC28A", borderRadius: 25, paddingVertical: 12, alignItems: "center", marginLeft: 10 },
